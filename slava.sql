...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 25 2023 г., 15:45
...
(14, 1, 1, '1', '1', '1@1', '2023-02-14', '10:00', 1),
(15, 1, 1, '1', '1', '1@1', '2023-02-25', '17:00', 0);
...
CREATE TABLE `rewiews` (
  ...
  `answer` varchar(1000) NOT NULL DEFAULT '0',
  `status` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 1, 2, 'bnfghbfdgfgf', 'gfdgfd', 'gfgfgf', '25.02.2023', 'gfgfgfgf', 0),
(2, 2, 2, '2', '2', '2', '2023-01-29', '0', 0);
